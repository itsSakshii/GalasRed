  ...
  services: [
    {
      ...
      title: "DJ Nights",
      description:
        "At our vibrant DJ Nights, we bring the pulsating energy of the dance floor.",
      img: img1,
    ...
    },
    {
      ...
      title: "Music Events",
      description:
        "Join us for exhilarating music events that showcase talented artists.",
      img: img2,
    ...
    },
    {
      ...
      description:
        "At our corporate events, we create an engaging atmosphere that fosters networking and collaboration.",
      img: img3,
      points: [
